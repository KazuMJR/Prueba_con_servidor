...
<div class="container py-4">
    <div class="d-flex justify-content-between align-items-center mb-3">
        <div>
            <h2 class="fw-bold mb-1">Gestión de Actividades</h2>
            <p class="text-muted mb-0">Administre las actividades registradas.</p>
        </div>
    ...
    <div class="card p-3 mb-3">
        <form method="GET" action="{{ route('actividades.index') }}" class="d-flex justify-content-start align-items-center gap-2 flex-wrap">
            <input
                type="text"
                id="busqueda"
                name="busqueda"
            ...
            <!-- Cambié este <a> por un botón para animar -->
                ...
                @foreach($actividades as $actividad)
                    <tr>
                        ...
                        <td class="text-center">
                            <a href="{{ route('actividades.show', $actividad->id_actividad) }}" class="btn btn-outline-info btn-sm me-1" title="Ver">
                                <i class="bi bi-eye"></i>
                            </a>
                            <a href="{{ route('actividades.edit', $actividad->id_actividad) }}" class="btn btn-outline-warning btn-sm me-1" title="Editar">
...
<!-- Scripts -->
<script>
    // Búsqueda en tiempo real para la tabla de actividades
    document.getElementById('busqueda').addEventListener('keyup', function () {
        var filtro = this.value.toLowerCase();
        var filas = document.querySelectorAll('#actividadesTableBody tr');
...
<!-- Transición de página y animación Cancelar -->
<script>
    document.addEventListener("DOMContentLoaded", () => {
        ...
        // Animación suave para el botón Cancelar
