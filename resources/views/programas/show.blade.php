...
<div class="container py-4">
    <h1 class="mb-4">
        <i class="bi bi-journal-text"></i> Detalles del Programa
    </h1>
    ...
    <div class="card shadow-sm">
        <div class="card-body">
            ...
            <p class="mb-0"><strong>Grado:</strong> {{ $programa->grado->nombre_grado }}</p>
            <p class="mb-0"><strong>Curso:</strong> {{ $programa->curso->nombre_curso }}</p>
        </div>
    </div>
