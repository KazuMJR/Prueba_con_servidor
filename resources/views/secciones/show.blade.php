...
<div class="container py-4">
    <h1 class="mb-4"><i class="bi bi-journal-text"></i> Detalles de la Sección</h1>

    <div class="card shadow-sm">
        <div class="card-body">
            <h5 class="card-title text-primary"><i class="bi bi-card-text"></i> Información general</h5>
            <p class="mb-0"><strong>Letra:</strong> {{ $seccion->letra }}</p>
        </div>
    </div>
    ...
    <div class="mt-4 d-flex justify-content-between flex-wrap gap-2">
        ...
        <div class="d-flex gap-2">
            ...
            <form method="POST" action="{{ route('secciones.destroy', $seccion) }}" 
